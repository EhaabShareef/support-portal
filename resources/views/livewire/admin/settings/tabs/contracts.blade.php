<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-semibold text-neutral-800 dark:text-neutral-100">Contract Settings</h2>
            <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Manage contract types and statuses for organization contracts</p>
        </div>
    </div>
    ...
    <div class="bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700 rounded-lg">
        <div class="px-6 py-4 border-b border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-medium text-neutral-800 dark:text-neutral-100">Contract Types</h3>
                    <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Define the types of contracts your organization offers</p>
                </div>
    ...
    <div class="bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700 rounded-lg">
        <div class="px-6 py-4 border-b border-neutral-200 dark:border-neutral-700">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-medium text-neutral-800 dark:text-neutral-100">Contract Statuses</h3>
                    <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Define the possible statuses for contract lifecycle</p>
                </div>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        <div class="flex">
            ...
            <div class="text-sm text-blue-800 dark:text-blue-200">
                ...
                <p>Contract types and statuses are currently stored in memory. When database lookup tables are implemented, changes will be persisted automatically.</p>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="bg-white dark:bg-neutral-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100">
                            {{ $typeEditMode ? 'Edit Contract Type' : 'Add New Contract Type' }}
                        </h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="flex flex-grow flex-col">
                                ...
                                <span class="text-sm text-neutral-500 dark:text-neutral-400">Prevent deletion of this contract type</span>
                            </span>
        ...
        <div class="inline-block align-bottom bg-white dark:bg-neutral-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form wire:submit="saveStatus">
                <div class="bg-white dark:bg-neutral-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100">
                            {{ $statusEditMode ? 'Edit Contract Status' : 'Add New Contract Status' }}
                        </h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="flex flex-grow flex-col">
                                <span class="text-sm font-medium text-neutral-700 dark:text-neutral-300">Protected</span>
                                <span class="text-sm text-neutral-500 dark:text-neutral-400">Prevent deletion of this contract status</span>
                            </span>
