                ...
                <div class="bg-white/5 backdrop-blur-md border border-neutral-200 dark:border-neutral-200/20 rounded-lg p-3 hover:bg-white/10 transition-all duration-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-1 ml-3 flex-shrink-0">
                            ...
                            <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium {{ $user->is_active ? 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300' : 'bg-red-100 text-red-800 dark:text-red-900/40 dark:text-red-300' }}">
                            ...
                            @if($user->hasRole('client') && !$user->isPrimaryForOrganization($organization->id))
                                <button wire:click="setPrimaryUser({{ $user->id }})" 
                                        class="inline-flex items-center p-1.5 text-neutral-600 dark:text-neutral-400 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded transition-colors duration-200"
