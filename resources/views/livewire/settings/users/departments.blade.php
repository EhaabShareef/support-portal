<div class="space-y-6">
    ...
    <div class="bg-white/5 backdrop-blur-md border border-neutral-200 dark:border-neutral-200/20 rounded-lg p-6 shadow-md">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Create and manage departments. Departments can belong to multiple groups for overlapping access.</p>
            </div>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
        <div class="px-6 py-4 border-b border-neutral-200 dark:border-neutral-700 grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="flex items-center gap-3">
                <x-heroicon-o-magnifying-glass class="h-4 w-4 text-neutral-400" />
                <input type="text" wire:model.live="search" placeholder="Search departments..." class="flex-1 text-sm border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-700 px-3 py-2 focus:ring-blue-500 focus:border-blue-500 dark:text-neutral-100">
            </div>
            <div>
                <select wire:model.live="filterGroup" class="w-full text-sm border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-700 px-3 py-2 focus:ring-blue-500 focus:border-blue-500 dark:text-neutral-100">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                ...
                <tbody class="bg-white dark:bg-neutral-800 divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-900 dark:text-neutral-100">
                                @if($department->departmentGroup)
                                    <div class="flex items-center">
                                        <span class="inline-block h-3 w-3 rounded-full mr-2" style="background-color: {{ $department->departmentGroup->color }}"></span>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-neutral-500 dark:text-neutral-400">No departments found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        <div class="px-6 py-3 border-t border-neutral-200 dark:border-neutral-700">{{ $departments->links() }}</div>
    </div>
